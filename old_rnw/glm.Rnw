...
\begin{exercice}
\filename{famille_expo_lineaire}
\title{Famille exponentielle linéaire}
...
\begin{exercice}
\filename{lien_poisson}
\title{Fonctions de lien avec une loi de Poisson}
...
\begin{exercice}
\filename{lien_gamma}
\title{Fonctions de lien avec une loi gamma}
...
\begin{exercice}
\filename{glm_poisson_univarie}
\title{GLM Poisson univarié}
...
\begin{exercice}
\filename{deviance_binomiale}
\title{Déviance du modèle binomial}
...
\begin{exercice}
\filename{residus_gamma}
\title{Résidus pour la loi gamma}
...
\begin{exercice}
\filename{tests_resistance}
\title{Tests de résistance}
<<echo=FALSE>>=
...
\begin{exercice}
\filename{sinistres_auto_royaume_uni}
\title{Sinistres automobiles au Royaume-Uni}
<<echo=FALSE>>=
...
\begin{exercice}
\filename{turbines_fissurees}
\title{Nombre de turbines fissurées}
<<echo=FALSE>>=
