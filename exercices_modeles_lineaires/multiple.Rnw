...
\begin{exercice}
  ...
  \begin{align*}
    S(\betavec)
    &= \sum_{i=1}^n (Y_i - \xvec_i \betavec)^2 \\
  ...
  forme matricielle,
  \begin{displaymath}
    (\Xmat^\top \Xmat) \hat\betavec = \Xmat^\top \yvec,
  \end{displaymath}
  ...
  \begin{sol}
    ...
    \ref{chap:elements},
    \begin{displaymath}
      \frac{d}{d \Xmat}\, f(\Xmat)^\prime \mat{A} f(\Xmat) =
      2 \left( \frac{d}{d \Xmat} f(\Xmat) \right)^\prime \mat{A} f(\Xmat).
    \end{displaymath}
    Il suffit, pour faire la démonstration, d'appliquer directement ce
    résultat à la forme quadratique
    \begin{displaymath}
      S(\betavec) = (\yvec - \Xmat \betavec)^\prime (\yvec - \Xmat \betavec)
    \end{displaymath}
    ...
    \begin{align*}
      ...
      \right)^\prime
      \yvec - \Xmat \betavec \\
      &= 2 (-\Xmat)^\prime (\yvec - \Xmat \betavec)\\
      &= -2 \Xmat^\prime (\yvec - \Xmat \betavec).
    \end{align*}
...
\begin{exercice}
  ...
  matrice de schéma $\Xmat$ dans la représentation $\yvec =
  ...
  \begin{sol}
    ...
    \item On a un modèle sans variable explicative. Intuitivement, la
      ...
      \begin{align*}
        \hat\betavec
        &=\left(\Xmat^\prime \Xmat \right)^{-1} \Xmat^\prime
        \yvec \\
        &=
        \left(
          \begin{bmatrix}
...
\begin{exercice}
  ...
  $\var{\hat\betavec} = \sigma^2 (\Xmat^\top \Xmat)^{-1}$
...
\begin{exercice}
  ...
  simple. Utiliser $\hat\epsvec = \yvec - \hat\yvec$.
  \begin{enumerate}
  \item $\Xmat^\top \epsvec = 0$
  \item $\hat\yvec^\top \epsvec = 0$
  \item $\hat\yvec^\top \hat\yvec = \hat\betavec^\top
    \Xmat^\top \yvec$
  \end{enumerate}
  ...
  \begin{sol}
    ...
    seront utilisées:
    $\mat{e} = \mat{y - \hat{y}}$,
    $\mat{\hat{y}} = \Xmat \hat\betavec$ et
    $\hat\betavec = (\Xmat^\prime \Xmat)^{-1} \Xmat^\prime \yvec$.
    \begin{enumerate}
    \item On a
      \begin{align*}
        \Xmat^\prime \mat{e}
        &= \Xmat^\prime (\mat{y - \hat{y}}) \\
        &= \Xmat^\prime (\yvec - \Xmat \hat\betavec) \\
        &= \Xmat^\prime \yvec - (\Xmat^\prime \Xmat) \hat\betavec \\
        &= \Xmat^\prime \yvec - (\Xmat^\prime \Xmat)
        (\Xmat^\prime \Xmat)^{-1} \Xmat^\prime \yvec \\
        &= \Xmat^\prime \yvec - \Xmat^\prime \yvec \\
        &= \mat{0}.
      \end{align*}
      ...
      \begin{align*}
        ...
        \end{bmatrix}.
      \end{align*}
      Par conséquent, $\Xmat^\prime \mat{e} = \mat{0}$ se simplifie
     ...
     \item On a
       \begin{align*}
         \hat{\yvec}^\prime \mat{e}
         &= (\Xmat\hat\betavec)^\prime (\mat{y - \hat{y}}) \\
         &= \hat\betavec^\prime \Xmat^\prime (\yvec - \Xmat\hat\betavec) \\
         &= \hat\betavec^\prime \Xmat^\prime \yvec - \hat\betavec^\prime
         (\Xmat^\prime \Xmat) \hat\betavec \\
         &= \hat\betavec^\prime \Xmat^\prime \yvec - \hat\betavec^\prime
         (\Xmat^\prime \Xmat) (\Xmat^\prime \Xmat)^{-1}
         \Xmat^\prime \yvec \\
         &= \hat\betavec^\prime \Xmat^\prime \yvec - \hat\betavec^\prime
         \Xmat^\prime \yvec \\
         &= 0.
       ...
       $\hat{\yvec}^\prime \mat{e} = \hat\betavec^\prime \Xmat^\prime
       \mat{e}$ et donc, en supposant sans perte de généralité que
       $\hat\betavec \ne \mat{0}$, 
       que $\hat{\yvec}^\prime \mat{e} = 0$
       et $\Xmat^\prime \mat{e} = \mat{0}$ sont des conditions en
       tous points équivalentes.
     \item On a
       \begin{align*}
         \mat{\hat{y}}^\prime \mat{\hat{y}}
         &= (\Xmat \hat\betavec)^\prime \Xmat \hat\betavec \\
         &= \hat\betavec^\prime (\Xmat^\prime \Xmat) \hat\betavec \\
         &= \hat\betavec^\prime (\Xmat^\prime \Xmat) (\Xmat^\prime
         \Xmat)^{-1} \Xmat^\prime \yvec \\
         &= \hat\betavec^\prime \Xmat^\prime \yvec.
       \end{align*}
...
\begin{exercice}
  ...
  \item Démontrer que l'erreur dans la prévision de la valeur moyenne
    ...
    \begin{displaymath}
      ...
      \sigma^2\, \Xmat_0 (\Xmat^\prime \Xmat)^{-1} \Xmat_0^\prime.
    \end{displaymath}
  ...
  \item Démontrer que l'erreur dans la prévision de $Y_0$ est
    \begin{displaymath}
      \esp{(Y_0 - \hat{Y}_0)^2} =
      \sigma^2\, (1 + \Xmat_0 (\Xmat^\prime \Xmat)^{-1} \Xmat_0^\prime).
    \end{displaymath}
    Construire un intervalle de confiance de niveau $1 - \alpha$ pour
    $Y_0$.
  \end{enumerate}
  \begin{sol}
    \begin{enumerate}
    \item Premièrement, $Y_0 = \Xmat_0 \betavec + \varepsilon_0$ avec
      $\esp{\varepsilon_0} = 0$. Par conséquent, $\esp{Y_0} = \esp{x_0
        \betavec + \varepsilon_0} = \Xmat_0 \betavec$. Deuxièmement,
      $\esp{\hat{Y}_0} = \esp{\Xmat_0 \hat\betavec} = \Xmat_0
    ...
    \item Tout d'abord, $\esp{(\hat{Y}_0 - \esp{Y_0})^2} =
      ...
      \ref{thm:elements:esp_var},
       \begin{align*}
         \var{\hat{Y}_0}
         &= \varmat{\Xmat_0 \hat\betavec} \\
         &= \Xmat_0 \varmat{\hat\betavec} \Xmat_0^\prime \\
         &= \sigma^2 \Xmat_0 (\Xmat^\prime \Xmat)^{-1}
         \Xmat_0^\prime.
       \end{align*}
       ...
       \begin{displaymath}
         ...
         \sqrt{\Xmat_0 (\Xmat^\prime \Xmat)^{-1} \Xmat_0^\prime}.
       \end{displaymath}
     ...
     \item Par le résultat obtenu en a) et en supposant que
       ...
       \begin{align*}
         ...
         &= \sigma^2 (1 + \Xmat_0 (\Xmat^\prime \Xmat)^{-1}
         \Xmat_0^\prime).
       \end{align*}
       ...
       \begin{displaymath}
         Y_0
         \in \hat{Y}_0 \pm z_{\alpha/2}\, \sigma\,
         \sqrt{1 + \Xmat_0 (\Xmat^\prime \Xmat)^{-1} \Xmat_0^\prime}.
       \end{displaymath}
...
\begin{exercice}
  ...
  \begin{center}
    ...
    \end{tabular}
  \end{center}
  De plus, si $\Xmat$ est la matrice de schéma du modèle
  \begin{displaymath}
  ...
  \begin{sol}
    ...
    \item Avec les résultats de la partie a), on a
      \begin{align*}
        \mat{\hat{y}} &= \Xmat \hat\betavec =
        \begin{bmatrix}
          17 \\ 12 \\ 13,5 \\ 13,5
        \end{bmatrix}, \\
        \mat{e} &= \yvec - \mat{\hat{y}} =
        \left[
          \begin{array}{r}
            0 \\ 0 \\ 0,5 \\ -0,5
          \end{array}
    ...
    \item On sait que $\var{\hat{\beta}_i} = \sigma^2 c_{ii}$, où
      ...
      $(\Xmat^\prime \Xmat)^{-1}$. Or, $\hat{\sigma}^2 = s^2 =
    ...
    \item Soit $\Xmat_0 = \begin{bmatrix} 1 & 3,5 & 9 \end{bmatrix}$
      et $Y_0$ la valeur de la variable dépendante correspondant à
      $\Xmat_0$. La prévision de $Y_0$ donnée par le modèle trouvé
      en a) est
      \begin{align*}
        \hat{Y}_0
        &= \Xmat_0 \hat\betavec \\
      ...
      \begin{align*}
        ...
        &= s^2 (1 + \Xmat_0 (\Xmat^\prime \Xmat)^{-1} \Xmat_0^\prime) \\
        &= 1,1875.
      \end{align*}
      Par conséquent, un intervalle de confiance à 95~\% pour $Y_0$
      est
      \begin{align*}
        \esp{Y_0} &\in \hat{Y}_0 \pm t_{0,025}(1) s \sqrt{1 + \Xmat_0
          (\Xmat^\prime \Xmat)^{-1} \Xmat_0^\prime} \\
...
@
      ...
      \begin{displaymath}
        ...
        \Sexpr{format(signif(b[2], 4), dec = ",")} X_{t1} +
        \Sexpr{format(signif(b[3], 4), dec = ",")} X_{t2} +
        \varepsilon_t,
        \quad
        \epsvec_t \sim N(0,
...
\begin{exercice}
  ...
  N(\betavec, \sigma^2 (\Xmat^\prime \Xmat)^{-1})$ et
  ...
  \item Vérifier que
    ...
    matrice $(\Xmat^\prime \Xmat)^{-1}$ et $s^2 = \text{MSE}$.
...
\begin{exercice}
  ...
  \begin{align*}
    S(\betavec)
    &= \sum_{t=1}^n w_t (\yvec_t - \Xmat_t^\prime \betavec)^2 \\
    &= (\yvec - \Xmat \betavec)^\prime\, \mat{W}\, (\yvec -
       \Xmat \betavec)
  \end{align*}
  par rapport à $\betavec$, que les équations normales à résoudre pour
  ...
  \begin{displaymath}
    (\Xmat^\prime\, \mat{W}\, \Xmat) \hat\betavec^* = \Xmat^\prime\,
    \mat{W}\,  \yvec,
  \end{displaymath}
  ...
  \begin{sol}
    ...
    \begin{align*}
      ...
      &= 2 \left(\frac{d}{d\betavec}(\yvec - \Xmat
        \betavec)\right)^\prime \mat{W} (\yvec - \Xmat
        \betavec) \\
      &= - 2 \Xmat^\prime \mat{W} (\yvec - \Xmat
        \betavec) \\
      &= -2 (\Xmat^\prime \mat{W} \yvec - \Xmat^\prime \mat{W}
      \Xmat \betavec).
    \end{align*}
    ...
    $S(\betavec)$ sont $(\Xmat^\prime\, \mat{W}\, \Xmat) \hat\betavec^* =
    \Xmat^\prime\, \mat{W}\, \yvec$ et l'estimateur des moindres
    carrés pondérés est
    \begin{displaymath}
      \hat\betavec^* = (\Xmat^\prime \mat{W} \Xmat)^{-1} \Xmat^\prime
      \mat{W} \yvec.
    \end{displaymath}
  \end{sol}
\end{exercice}
...
\begin{exercice}
  ...
  \begin{sol}
    ...
    \begin{align*}
      \varmat{\hat\betavec^*}
      &= (\Xmat^\prime \mat{W} \Xmat)^{-1} \Xmat^\prime \mat{W}
      \varmat{\yvec}
      \mat{W}^\prime \Xmat (\Xmat^\prime \mat{W} \Xmat)^{-1} \\
      &= \sigma^2
      (\Xmat^\prime \mat{W} \Xmat)^{-1} \Xmat^\prime \mat{W}
      \mat{W}^{-1}
      \mat{W} \Xmat (\Xmat^\prime \mat{W} \Xmat)^{-1} \\
      &= \sigma^2 (\Xmat^\prime \mat{W} \Xmat)^{-1}
    \end{align*}
    puisque les matrices $\mat{W}$ et $\Xmat^\prime \mat{W} \Xmat$
...
@
  \begin{rep}
    $Y_t = \Sexpr{format(b[1], dec = ",")} +
    \Sexpr{format(b[2], dec = ",")} X_t +
    \Sexpr{format(b[3], dec = ",")} X_t^2 + \varepsilon_t$,
    $\varepsilon_t \sim N(0, \Sexpr{format(s2, dec = ",")})$
  \end{rep}
  \begin{sol}
...
@
    ...
    \begin{displaymath}
      Y_t = \Sexpr{format(b[1], dec = ",")} +
      \Sexpr{format(b[2], dec = ",")} X_t +
      \Sexpr{format(b[3], dec = ",")} X_t^2 + \varepsilon_t, \quad
      \varepsilon_t \sim N(0, \Sexpr{format(s2, dec = ",")}).
    \end{displaymath}
    \begin{figure}
      \centering
