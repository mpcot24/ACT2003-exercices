...
Considérer le modèle de régression linéaire passant par l'origine
  présenté à l'exercice @simple.@sec-simple-estimateurs_moindres_carres_origine.
...
**a)** $\varepsilon_i \sim N(0, \sigma^2)$;

**b)** $\cov{\varepsilon_0, \varepsilon_i} = 0$ pour tout $i = 1, \dots, n$;

**c)** $\var{\varepsilon_i} = \sigma^2$ est estimé par $s^2$,
