...
**a)** On trouve les résultats suivants: ```{r} M0 <- glm(cbind(Success,Trials-Success) 1,binomial) M1 <- glm(cbind(Success,Trials-Success) x,binomial) summary(M0) summary(M1) ```

**b)** On trouve les résultats suivants: ```{r} M0v2 <- glm(Successv2 1,binomial) M1v2 <- glm(Successv2 xv2,binomial) summary(M0v2) summary(M1v2) ```
...
**e)** L'analyse de déviance donne exactement le même résultat dans les deux cas. Pour les données Binomiales, on a que $$ \Delta Deviance = 6.2568 - 6.2568 =5.2724 > \chi^2_{95\
:::
