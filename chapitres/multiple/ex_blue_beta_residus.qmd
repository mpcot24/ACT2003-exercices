...
De manière tout à fait générale, l'estimateur linéaire sans biais
    ...
    $$
      ...
      \mat{W} \yvec
    $$
    et sa variance est, par le théorème de la section **[réf:sec:elements:moments]**,
    $$
\begin{aligned}
      \varmat{\hatbetavec^*}
...
\begin{aligned}
    ...
    \end{aligned}
$$
**a)** Cas déjà traité à l'exercice @simple.@sec-simple-estimateurs_moindres_carres_origine où $\mat{W} = \mat{I}$ et, donc, $$
