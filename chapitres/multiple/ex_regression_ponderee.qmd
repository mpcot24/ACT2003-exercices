...
$$
  ...
  $$
    ...
    \mat{W}   \yvec,
  $$
  puis en déduire cet estimateur.  *Astuce*: cette preuve est
  simple si l'on utilise le théorème **Dérivée d'une fonction** de la section **[réf:sec:elements:derivees]**
